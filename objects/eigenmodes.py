...
from lys.utils.paths import lys_data_dir, get_subjects_dir
...
def load_eigenmodes(patient: str) -> List[Eigenmode]:
    ...
    """
    path = get_subjects_dir() / patient / "anat" / "meshes" / f"{patient}_EIGMOD_MPR_IIHC_MNI_WM_LH_edited_again_RECOSM_unMNI_D32k_eigenmodes.mat"
    mdata = loadmat(path)
