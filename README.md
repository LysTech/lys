...
- [Visualization](#visualization)
  ...
  - [Channel Data Plots](#channel-data-plots)
    - [Snapshot Testing for Visualization](#snapshot-testing-for-visualization)
- [Preprocessing](#preprocessing)
  - [How to Use Preprocessing](#how-to-use-preprocessing)
  - [How It Works](#how-it-works)
  - [Current Supported Devices](#current-supported-devices)
  - [Extending for New Devices](#extending-for-new-devices)
- [Some of our objects](#some-of-our-objects)
  - [Patient Class](#patient-class)
    - [How to Instantiate a Patient](#how-to-instantiate-a-patient)
  ...
  - [Eigenmodes](#eigenmodes)
    - [How to Load Eigenmodes](#how-to-load-eigenmodes)
    - [File Location and Naming Convention](#file-location-and-naming-convention)
    - [Data Structure](#data-structure)
    - [Eigenmode Objects](#eigenmode-objects)
